...
public class achievementManager : MonoBehaviour {
	...
	void Start () {
		...
		//timesAchieved2 = PlayerPrefs.GetFloat("timesAchieved2", 0);
    }
    ...
    void OnDestroy()
    {
        ...
        //PlayerPrefs.GetFloat("timesAchieved2", timesAchieved2);
    }
}
